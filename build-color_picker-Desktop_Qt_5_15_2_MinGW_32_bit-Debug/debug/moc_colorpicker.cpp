...
#include <memory>
#include "../../color_picker/colorpicker.h"
...
QT_MOC_LITERAL(4, 35, 18), // "colorButtonClicked"
QT_MOC_LITERAL(5, 54, 3) // "num"

    },
    "ColorPicker\0colorChanged\0\0newColor\0"
    "colorButtonClicked\0num"
};
...
void ColorPicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->colorButtonClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }

...
#include <memory>
#include "../../Signals_And_Slots/destination.h"
...
QT_MOC_LITERAL(1, 12, 9), // "onMessage"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 7) // "message"

    },
    "destination\0onMessage\0\0message"
};
...
void destination::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onMessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
